                        ...
                        <div class=" overflow-x-auto">
                          <div class="w-full">
                            <div class="relative text-gray-500 focus-within:text-gray-900 mb-4 flex justify-between items-center">
                                ...
                                <a href="{{ route('admin.categories.create') }}" class="text-black bg-transparent border border-black hover:bg-black hover:text-white duration-100 font-bold py-2 px-4 rounded-full">
                                    {{ __('Ajouter') }}
                                </a>
                            </div>
                              <div class="overflow-hidden ">
                                  <table class=" min-w-full rounded-xl">
                                      <thead>
                                          <tr class="bg-gray-50">
                                              <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-s-xl"> Label </th>
                                              <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-e-xl"> Actions </th>
                                          </tr>
                                      </thead>
                                      ...
                                      @else
                                          <tbody class="divide-y divide-gray-300">
                                              ...
                                              <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                                  <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ $categorie->nom_categorie }}</td>
                                                  <td class="p-5">
                                                        <div class="flex items-center gap-1">
                                                            <a href="{{ route('admin.categories.edit', $categorie->id) }}" class="p-2 rounded-full group transition-all duration-500 flex items-center">                                                            
                                                            ...
                                                            <button
                                                                class="p-2 rounded-full group transition-all duration-500 flex items-center text-red-600 hover:bg-red-100" 
                                                                onclick="event.preventDefault(); if(confirm('{{ __('Voulez-vous vraiment supprimer la categorie ?') }}')) { document.getElementById('delete-form-{{ $categorie->id }}').submit(); }">
                                                            ...
                                                            <form id="delete-form-{{ $categorie->id }}" action="{{ route('admin.categories.destroy', $categorie->id) }}" method="POST" style="display: none;">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
