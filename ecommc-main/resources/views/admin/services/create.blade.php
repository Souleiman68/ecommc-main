        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-200">
                    ...
                    @if ($errors->any())
                        <div class="mb-8 p-4 bg-red-500 rounded-lg shadow-md">
                            <h2 class="text-xl font-bold text-white">{{ __('Il y a des erreurs dans votre formulaire :') }}</h2>
                            <ul class="mt-2 text-sm text-red-100">
                    ...
                    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-200" placeholder="Décrivez le service en détail">{{ old('description') }}</textarea>
                        </div>
